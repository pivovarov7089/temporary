...
Функция Get(URL, ПараметрыЗапроса = Неопределено, ДополнительныеПараметры = Неопределено, Сессия = Неопределено) Экспорт
	...
	Дополнить(Параметры, НовыеПараметры());
...
Функция Post(URL, Данные = Неопределено, ДополнительныеПараметры = Неопределено, Сессия = Неопределено) Экспорт
	...
	//сделал так, потому что при этом не вставляются дополнительные параметры
...
//     Параметры преобразования см. ДополнительныеПараметры.ПараметрыПреобразованияJSON
//
Функция PatchJson(URL, Json, ДополнительныеПараметры = Неопределено, Сессия = Неопределено) Экспорт
	...
	Возврат КакJson(ВызватьHTTPМетод(ТекущаяСессия, "PATCH", URL, Параметры), ПараметрыПреобразованияJSON);
...
//дописал для сайта
Функция ВызватьМетодJson(URL, Метод, Json, ДополнительныеПараметры = Неопределено, Сессия = Неопределено) Экспорт
...
Функция ОбъектВJson(Объект, Знач ПараметрыПреобразования = Неопределено, Знач ПараметрыЗаписи = Неопределено) Экспорт
	...
	ПараметрыЗаписи = Объединить(ПараметрыЗаписи, ПараметрыЗаписиJSONПоУмолчанию());
...
Функция JsonВОбъект(Json, Кодировка = "utf-8", ПараметрыПреобразования = Неопределено) Экспорт
	...
	ПараметрыПреобразованияJSON = Объединить(?(ПараметрыПреобразования = Неопределено, Новый Структура, ПараметрыПреобразования), ПараметрыПреобразованияJSONПоУмолчанию());
