	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		Пока ВыборкаПоТоварам.Следующий() Цикл
			...
			Если Не НаборыСервер.ИспользоватьОбластьКомплектующие(ВыборкаПоТоварам, ИспользоватьНаборы)
				...
				Иначе
					ИтогоШтук = ИтогоШтук + ВыборкаПоТоварам.КоличествоВБазовыхЕдиницах;
				КонецЕсли;
			КонецЕсли;
		...
		Если Не ПустаяСтрока(ТекстИтогоКорШтВКолонке) Тогда
			ОбластьДанныеКоличество.Параметры.Заполнить(Новый Структура("Количество", ТекстИтогоКорШтВКолонке));
		КонецЕсли;
